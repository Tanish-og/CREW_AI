...
from crewai import tool as Tool
...
# ==============================================================================
# We are now explicitly creating an LLM object with the API key.
# This ensures it's always passed correctly and avoids the authentication error.
...
scrape_task = Task(
  description='Scrape the latest 200 tweets for the following X creators: CreatorA, CreatorB, CreatorC, CreatorC, CreatorD, CreatorE.',
